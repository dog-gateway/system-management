...
public class BundleManagerEndpoint implements BundleManager
{
    ...
    public String getBundles()
    {
        ...
        for (int i = 0; i < allBundles.length; i++)
        {
            ...
            currentBundle.setName(allBundles[i].getSymbolicName() + " ("
                    + allBundles[i].getVersion() + ")");
        ...
        catch (Exception e)
        {
            this.logger.log(LogService.LOG_ERROR,
                    "Error in creating the JSON object for the bundle list", e);
        }
    ...
    public String getOverallStatistics()
    {
        ...
        double activeRatio = (double) nActive
                / (double) (nActive + nResolved + nInstalled);
        ...
        {
            this.logger.log(LogService.LOG_ERROR,
                    "Error in creating the JSON object for the bundle statistics",
                    e);
        }
